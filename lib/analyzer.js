...
module.exports = function (code) {
    ...
    for (var i = 0; i < length; i++) {
        ...
        try {
            analyze(funct.body, desc, true);
            if (typeof desc.result === "undefined")
                throw new Error("No return value expressed.");
        } catch (error) {
...
function analyze(body, funct, block) {
    ...
    for (var i = 0; i < length; i++) {
        ...
        case "modulo":
            ...
            break;
        default:
            if (i < last) throw new Error("Function returns before the end of the code.");
